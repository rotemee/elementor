...
export default class Lightbox extends elementorModules.ViewModule {
	getDefaultSettings() {
		return {
			classes: {
	...
	prepareVimeoVideo( Vimeo, videoId, $videoContainer, $videoWrapper, $playIcon ) {
		const classes = this.getSettings( 'classes' ),
			vimeoOptions = {
				id: videoId,
				autoplay: true,
